...
class Git(object):
	...
	def clone(self):
		if os.path.exists(self.repo):
			sys.exit('fatal: destination path \'' + self.repo + '\' already exists and is not an empty directory.')
	...
	def push(self):
		pass
		os.system('git push https://' + self.username + ':' + self.password + '@github.com/' + self.username + '/' + self.repo)
